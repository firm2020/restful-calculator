...
This is a Minimal RESTful Calculator implemented whit Core backend using Spring Boot REST APIs & Frontend using Angular (https://angular.io/) / Angular Material design (https://material.angular.io).
